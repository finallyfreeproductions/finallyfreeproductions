			...
			<form method="post" action="options.php">
				...
				<ol>
					<li style="font-size: 18px; font-weight: bold; margin-top: 10px;margin-bottom:10px">Step One - Insert Your Biz Key</li>
						...
						<p> 
							If you don't have a Schedulicity account <a href="https://essentials.schedulicity.com/online-scheduling-plugin/?utm_source=wordpress&utm_medium=plugin&utm_campaign=free_launch" target="_blank">click here</a> to get your free account.
						</p>
						</ul>
			...
			<div style="background: #FFF;-moz-border-radius: 3px;border-radius: 3px;margin:5%;margin-top: 30px;padding: 20px;-moz-box-shadow: 0 0 5px #888;-webkit-box-shadow: 0 0 5px#888;box-shadow: 0 0 5px #888;">
				...
				<div id="bizkey">
					...
					<p style="margin-left: 20px; font-size: 14px">
						...
						<p style="margin-left: 20px; font-size: 14px">1. Make sure you have an active Schedulicity account. If you don't have one you can create one here for free: <a href="https://essentials.schedulicity.com/online-scheduling-plugin/?utm_source=wordpress&utm_medium=plugin&utm_campaign=free_launch" target="_blank">https://schedulicity.com</a></p>
